...
const Home = () => {
    ...
    const fetchEvents = async () => {
        try {
            ...
            console.log(response.data); // पहले console में देखो
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                ...
                                <div className="mt-auto">
                                    ...
                                    <p className="text-xs text-gray-500 mb-4">
                                        {event.availableSeats ?? 0} of {event.totalSeats ?? 0} seats remaining
                                    </p>                                    <Link to={`/events/${event._id}`} className="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold py-2 rounded-lg transition">
                                        View Details
                                    </Link>
                                </div>
                            </div>
